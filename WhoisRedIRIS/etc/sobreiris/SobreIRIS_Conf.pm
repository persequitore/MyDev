package Net::Whois::RedIRIS::DataConfig;
...
Set ($LogFile,'/var/log/RedIRISWhois.log');

# Puerto de escucha del socket
Set ($ListenOnPort, '43333');
...
Set ($LDAPInfo,[
        ...
        'irisPerson' => [
                ...
                'Filter' => '&(schacUserStatus=urn:mace:terena.org:schac:userStatus:es:rediris.es:affiliation:organization:VALUE_DATA)(urn:mace:terena.org:schac:userStatus:es:rediris.es:affiliation:role:techcontact)',
        ],
        'certPerson' => [
                'Host' => 'magnesio.rediris.es',
                'Port' => '1389',
